...
//!
//! Two functions and a constant, extracted because all four siblings need them.
//! `say` most of all: a refusal written twice is a refusal that can disagree
//! with itself, and §6 forbids a bare error in either copy.
